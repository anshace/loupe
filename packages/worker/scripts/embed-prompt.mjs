/**
 * Embeds prompts/reviewer-v4.md into src/generated/promptTemplate.ts.
 *
...
const promptPath = resolve(here, "..", "..", "..", "prompts", "reviewer-v4.md");
const outPath = resolve(here, "..", "src", "generated", "promptTemplate.ts");

const template = readFileSync(promptPath, "utf8");
const banner =
  "// AUTO-GENERATED from prompts/reviewer-v4.md by scripts/embed-prompt.mjs — DO NOT EDIT.\n" +
